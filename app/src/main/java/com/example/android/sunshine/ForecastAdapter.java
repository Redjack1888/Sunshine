...
//        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMillis, false);
        long normalizeUtcMidnight = dateInMillis + TimeZone.getDefault().getOffset(System.currentTimeMillis());

        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, normalizeUtcMidnight, false);
