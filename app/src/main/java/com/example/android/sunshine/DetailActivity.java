...
//        String dateText = SunshineDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);
        ...
        long normalizeUtcMidnight = localDateMidnightGmt + TimeZone.getDefault().getOffset(System.currentTimeMillis());
        String dateText = SunshineDateUtils.getFriendlyDateString(this, normalizeUtcMidnight, true);
